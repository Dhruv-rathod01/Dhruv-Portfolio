...
const Contact = () => {
  ...
  const whatsappClick = ()=>{
    const phoneNumber = '8791744022'; // Replace with your phone number
    const message = encodeURIComponent('Hi Dhruv, I saw your portfolio and would like to connect!');
        ...
        <div className='w-full h-screen p-2 md:p-6'>
          <div className="contact-wrapper relative w-full h-full bg-[#121212] rounded-lg overflow-hidden">
             <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20'>
               <h4 className='text-[var(--textWhite)]'>
  Let's Create Something Extraordinary Together

  <button
  onClick={() => window.location.href = '/contact'}
  className='text-xl flex gap-2 mt-2 items-center main-btn !text-[#121212] !bg-[var(--textWhite)]'
>
  💬 Chat with me
</button>
</h4>
