...
const Home = () => {
  ...
  return (
    <>
      ...
      <section className='relative'>
       ...
       <div className="my-img mt-2 md:mt-0 scale-100 md:scale-70 md:ml-[-5%]">
  ...
  alt=""
  className='last w-full h-full object-cover object-center grayscale-0'
/>
            </div>
            </CardTilt>
        ...
        <div className="my-para overflow-hidden absolute top-[30%] left-0 md:absolute md:top-[55%] md:left-[60%] flex flex-col gap-2">
          <p ref={lineRef} className='leading-[1] md:leading-[1.08] w-2/3 md:w-[90%] px-4 text-sm lg:text-[16px] overflow-hidden'>
            <SplitLine text='I’m a Java & Web Developer passionate about crafting modern, responsive, and user-friendly digital experiences with clean design, creative ideas, and efficient code.' />
          </p>
