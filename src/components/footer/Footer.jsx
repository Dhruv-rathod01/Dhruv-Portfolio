      ...
      <div>
         <div className='flex flex-col md:flex-row items-start gap-10 justify-evenly px-4'>
            ...
            <div className='flex flex-col md:flex-row gap-2 justify-between'>
              ...
              <ul className='p-0 flex flex-wrap justify-center items-center w-full md:w-[90%] lg:w-[80%]'>
                {data.map((l,i)=>(
            ...
            <div className='lg:w-1/3'>
              ...
              <div><a href="mailto:dhruvrathore49@gmail.com" className='text-base text-[var(--textWhite)] font-[Neue]'>dhruvrathore49@gmail.com</a></div>
              
              </div><div className='mt-6'>
                <p className='text-[var(--textWhite)] text-base'>+918791744022</p>
              <div className='mt-6'>
         ...
         <div className='w-full mt-6 p-4'>
          <h3 className='lg:text-[15rem] md:text-[6rem] font-[Neue] whitespace-nowrap text-[var(--textWhite)] text-center'>Dhruv Rathore</h3>
         </div>
         <div className='flex items-center justify-between p-2'>
          <p className='text-sm text-[var(--textWhite)]'>@2026</p>
          <p className='text-sm text-[var(--textWhite)]'>Developer</p>
          <p className='text-sm text-[var(--textWhite)]'>since 2023</p>
         </div>
      </div>
    </div>
  );
